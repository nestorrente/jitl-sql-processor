...
class QueryParser implements Closeable {
	...
	private QueryParser(SQLProcessor module, String query, Map<String, Object> parameters) {
		this.module = module;
	...
	public static ParsedQueryData parse(SQLProcessor module, String query, Map<String, Object> parameters) {
